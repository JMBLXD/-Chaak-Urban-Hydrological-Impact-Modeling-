classdef infiltracionNCMod
%% Modified curve number infiltration element
% //    Description:
% //        -Infiltration object
% //    Update History
% =============================================================
%
    properties
    metodo          % Method
    NCInicial       % Initial curve number
    NC              % SCS curve number 
    ...
    methods
        function obj=infiltracionNC(metodo,NCinicial)
        % //    Description:
        % //        -Create object
        % //    Update History
        % =============================================================
        %
            obj.metodo=metodo;
            obj.NCinicial=NCinial;
            obj.NC = obtenerCNMod(NCinicial);
            if (obj.NC < 10) 
                obj.NC=10;
            end
            if (obj.NC> 99) 
        ...
        function iniciarInfiltracion(obj)
        % //    Description:
